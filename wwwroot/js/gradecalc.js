...
function gradeCalc() {
    var iAssign = document.getElementById("assignments").value;
    var iGroup = document.getElementById("groupproj").value;
    var iQuiz = document.getElementById("quiz").value;
    var iExam = document.getElementById("exam").value;
